...
// The GroupMsgFunc type is an adapter to allow the use of ordinary
// function as GroupMsg mutator.
type GroupMsgFunc func(context.Context, *ent.GroupMsgMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f GroupMsgFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.GroupMsgMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.GroupMsgMutation", m)
}

// The GroupRelationFunc type is an adapter to allow the use of ordinary
// function as GroupRelation mutator.
type GroupRelationFunc func(context.Context, *ent.GroupRelationMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f GroupRelationFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.GroupRelationMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.GroupRelationMutation", m)
}
